...
st.set_page_config(page_title="Hello Chart - Visualize your excels",
                   page_icon="🌠",
                   layout='wide')
...
if upfile:
    ...
    available_files = [
        'static/data/titanic.csv',
        'static/data/vietnamese_thunhapbinhquan.csv',
        'static/data/Carbon Dioxide Emission Estimates.csv'
    ]
    #File upload event
    file_select = st.sidebar.selectbox(
        "You can also select a data from list bellow for demo",
        available_files)
